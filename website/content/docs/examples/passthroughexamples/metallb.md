...
{{< figure src="/images/openpemetallbpassthrough.svg" alt="MetalLB Passthrough" class="text-center" >}}
...
![MetalLB Passthrough Traffic Flow](/images/openpeemetallbpassthroughtraffic.svg)
