...
10. **Given** raw FRR configuration file is provided to perouter, **When** FRR daemon loads the configuration, **Then** EVPN BGP configuration for both L2 and L3 VPNs is active and matches CRD-based configuration output
...
- **FR-019**: System MUST provide a raw FRR configuration file consumable by the perouter containing the complete EVPN configuration for both L2 and L3 VPNs
- **FR-020**: Raw FRR configuration MUST be equivalent to the configuration generated by the CRD-based L2VNI and L3VNI controllers
...
- **FRR Configuration File**: Raw configuration file containing complete EVPN BGP setup for L2 and L3 VPNs, consumable by the perouter, equivalent to CRD-generated configuration.
