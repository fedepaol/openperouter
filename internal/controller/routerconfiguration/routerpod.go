...
var _ RouterManager = (*RouterPodManager)(nil)

type RouterPod struct {
	manager *RouterPodManager
	pod     *v1.Pod
}

var _ Router = (*RouterPod)(nil)

func (r *RouterPodManager) New(ctx context.Context) (Router, error) {
...
func (r *RouterPodManager) NodeIndex(ctx context.Context) (int, error) {
	var node v1.Node
...
func (r *RouterPod) Updater(ctx context.Context) (frr.Updater, error) {
